...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase DB) {
        DB.execSQL("create table user (user_phone text primary key, password text)");
    ...
    public Boolean update (String newpassword, String oldpassword) {
        SQLiteDatabase DB = this.getWritableDatabase();
        Cursor cursor = DB.rawQuery("update user set password = ?  where password = ?", new String[]{newpassword, oldpassword});
