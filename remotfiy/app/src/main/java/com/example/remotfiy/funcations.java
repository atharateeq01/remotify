...
public class funcations extends AppCompatActivity {
    ...
    Switch s_sound, s_bln, s_blo, s_fo, s_fn;
    Button back, save;
    DBcom DB;
   ...
   //     s_sound =findViewById(R.id.s_sound);
        ...
        s_sound.setChecked(sharedPreferences.getBoolean("value",true));
        s_bln.setChecked(sharedPreferences.getBoolean("value2",true));
        s_blo.setChecked(sharedPreferences.getBoolean("value3",true));
        s_fn.setChecked(sharedPreferences.getBoolean("value4",true));
        s_fo.setChecked(sharedPreferences.getBoolean("value5",true));
